            ...
            <div className="layout-grid">
                <div className="feature-item item-1">
                    <div className="feature-image-wrapper">
                        <img src="/images/icon-shipping-box.svg" className="feature-image" />
                    </div>
                ...
                <div className="feature-item item-2">
                    <div className="feature-image-wrapper">
                        <img src="/images/icon-dolly.svg" className="feature-image" />
                    </div>
                ...
                <div className="feature-item item-3">
                    <div className="feature-image-wrapper">
                        <img src="/images/icon-dresser.svg" className="feature-image" />
                    </div>
